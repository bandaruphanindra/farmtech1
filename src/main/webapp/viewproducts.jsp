    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link" href="addproducts">Add Product</a></li>
                <li class="nav-item"><a class="nav-link" href="viewproducts">View Products</a></li>
                <li class="nav-item"><a class="nav-link" href="farmerlogin">Logout</a></li>
            </ul>
        </div>
    </nav>
                ...
                <tbody>
                    ...
                    <c:forEach items="${products}" var="product">
                        <tr>
                            ...
                            <td>
                                <!-- Add Update Button -->
                                <a href="updateproduct/${product.id}" class="btn btn-warning btn-sm">Update</a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
